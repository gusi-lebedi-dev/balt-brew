...
function baltic_register_home_acf(): void
{
    ...
    $fields = [
        ...
        [
            ...
            'name' => '',
            'type' => 'message',
            'message' => 'Добавление и редактирование новостей находится в отдельном разделе «Новости» в левом меню. На главной автоматически показывается последняя опубликованная новость.',
        ],
        ...
        [
            ...
            'name' => '',
            'type' => 'message',
            'message' => 'Добавляйте публикации в разделе «Записи». Последняя опубликованная запись показывается на главной. Поля ниже служат запасным текстом, если записей пока нет.',
        ],
